    ...
    <div class="main">
        ...
        <div class="manage">
            <form action="../productCategoryServlet">
                <input type="hidden" name="status" value="productCategoryAdd" />
                <table class="form">
                    <tr>
                        <td class="field">分类名称：</td>
                        <td><input type="text" class="text" name="pcname" value="" /></td>
                    </tr>
                    <tr>
                        <td class="field">父级编号：</td>
                        <td><input type="text" class="text" name="parentid" value="" /></td>
                    </tr>
                    <tr>
                        <td></td>
