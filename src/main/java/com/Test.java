...
import com.jlu.comments.service.CommentsService;
import com.jlu.news.dao.NewsDao;
import com.jlu.product.dao.ProductDao;

import com.jlu.news.service.NewsService;
import com.jlu.product.service.ProductService;
import com.jlu.users.dao.UsersDao;
import com.jlu.users.service.UsersService;
import com.jlu.util.BaseDao;
...
public class Test {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        ResultSet rs = bs.executeQuery("select count(NAME) over () as count,name from \"users\"",null);
        while(rs.next()){
            int count = rs.getInt("count");
            String s = rs.getString("name");
            System.out.println(count+"      "+s);
        }
//        int i = bs.executeUpdate("insert into \"user\" values ('你好')",null);
