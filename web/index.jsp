...
<div id="header" class="wrap">
    ...
    <div class="help"><a href="#" class="shopping">购物车</a><a href="login.jsp">登录</a><a href="register.jsp">注册</a><a
            href="manager/guestbook.jsp">留言</a></div>
    <div class="navbar">
        <ul class="clearfix">
            ...
            <ul class="product clearfix">
                ...
                <li>
                    <dl>
                        ...
                        <dd class="title"><a href="productServlet?status=productView&pid=<%=product.getPid()%>"
                                             target="_blank"><%=product.getPname()%>
                        </a></dd>
                    ...
                    <%
                        ...
                        if (newsobj != null)
                        {
                            ...
                            for (int i = 0; i < newsList.size(); i++)
                            {
                                ...
                                {
                    %>
                    <li><a href="newsServlet?status=newsView&nid=<%=news.getNid()%>"
                           target="_blank"><%=news.getTitle().substring(0, 15)%>...</a></li>
                    <%
                    }
                    else
                    {
