...
<div id="main" class="wrap">
	...
	<%
		//获取商品
		Object proobj = session.getAttribute("product");
		if (proobj != null) {
			Product p = (Product) proobj;
	%>
	<div id="product" class="main">
		<h1><%=p.getPname()%></h1>
		<div class="infos">
			<div class="thumb"><img src=images/product/<%=p.getFilename()%> /></div>
			<div class="buy">
				<p>商城价：<span class="price">￥<%=p.getPrice()%></span></p>
				<p>库　存：有货(库存<%=p.getStock()%>件)			  </p>
		...
		<div class="introduce">
			...
			<div class="text"><%=p.getPdescription()%><br />
			</div>
		</div>
	</div>
	<%
